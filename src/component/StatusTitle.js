    ...
    <Wrapper>
        <Board>
            ...
            <Column key={status}>
              <h2>
               ...
               <div>
               {
                ...
                <span style={{marginLeft:'8px'}}>{status}</span> <span className="count" style={{marginLeft:'8px'}}>{tasksInStatus.length}</span>
          ...
          <Column>
            ...
            <span style={{marginLeft:'8px'}}>Canceled</span> <span className="count" style={{marginLeft:'8px'}}>0</span>
